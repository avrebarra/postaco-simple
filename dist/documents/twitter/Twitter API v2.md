# Twitter API v2 {328872360452252000}
...
## Filtered Stream {364813010652254000}

### Add Rules {63224374752255000}

| | |
|--|--|
|__Name__| Add Rules|
|__URL__| https://api.twitter.com/2/tweets/search/stream/rules |
|__Method__| POST|
...
##### Example 1: 403 Forbidden - Client Not Enrolled
...
##### Example 2: Success 201 - Create Rules with Dry Run
...
##### Example 3: Success 201 - Created List of Rules
...
##### Example 4: 400 - Bad Request (Delete)
...
##### Example 5: 400 - Bad Request (Create)
...
##### Example 6: Success 200 - Errors for Invalid Rule
...
##### Example 7: Success 200 - Delete Rule
...
### Delete Rules (by rule ID) {3923260252267000}

| | |
|--|--|
|__Name__| Delete Rules (by rule ID)|
|__URL__| https://api.twitter.com/2/tweets/search/stream/rules |
|__Method__| POST|
...
##### Example 1: 400 - Bad Request (Delete)
...
##### Example 3: 400 - Bad Request (Create)
...
##### Example 4: Success 200 - Delete Rule
...
##### Example 5: Success 201 - Created List of Rules
...
##### Example 7: 403 Forbidden - Client Not Enrolled
...
### Delete Rules (by rule value) {281592287852281000}

| | |
|--|--|
|__Name__| Delete Rules (by rule value)|
|__URL__| https://api.twitter.com/2/tweets/search/stream/rules |
|__Method__| POST|
...
##### Example 1: 400 - Bad Request (Create)
...
##### Example 2: Success 200 - Delete Rule
...
##### Example 3: 400 - Bad Request (Delete)
...
##### Example 4: Success 201 - Create Rules with Dry Run
...
##### Example 6: 403 Forbidden - Client Not Enrolled
...
##### Example 7: Success 200 - Errors for Invalid Rule
...
### Retrieve Rules {372556955452288000}

| | |
|--|--|
|__Name__| Retrieve Rules|
|__URL__| https://api.twitter.com/2/tweets/search/stream/rules |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/tweets/search/stream/rules'
```
...
##### Example 1: Success 200 - Retrieve Rules
...
##### Example 2: 403 Forbidden - Client Not Enrolled
...
### Stream (see description) {42744196152291000}

| | |
|--|--|
|__Name__| Stream (see description)|
|__URL__| https://api.twitter.com/2/tweets/search/stream |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/tweets/search/stream'
```
...
##### Example 1: 429 - Too Many Requests
...
## Hide replies {394885977352294000}

### Hide a reply {284331535452294000}

| | |
|--|--|
|__Name__| Hide a reply|
|__URL__| https://api.twitter.com/2/tweets/:id/hidden |
|__Method__| PUT|
...
curl -X 'PUT' -d '{
    "hidden": true
}' -H 'Content-Type: application/json' 'https://api.twitter.com/2/tweets/:id/hidden'
```




### Unhide a reply {80094108952295000}

| | |
|--|--|
|__Name__| Unhide a reply|
|__URL__| https://api.twitter.com/2/tweets/:id/hidden |
|__Method__| PUT|
...
## Recent Search {274607355452296000}

### Recent Search {274607355452297000}

| | |
|--|--|
|__Name__| Recent Search|
|__URL__| https://api.twitter.com/2/tweets/search/recent?query= |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/tweets/search/recent?query='
```
...
##### Example 1: 200 Success - Request Expanded Media Fields
...
##### Example 2: 200 Success - Recent Search (Default Payload)
...
##### Example 3: 200 Success - Request Tweet Fields
...
##### Example 4: 200 Success - Request Tweet Fields with Expanded User Fields
...
## Sampled Stream {329686542752311000}

### Stream (see description) {42744196152312000}

| | |
|--|--|
|__Name__| Stream (see description)|
|__URL__| https://api.twitter.com/2/tweets/sample/stream |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/tweets/sample/stream'
```




## Tweet Lookup {28117748852314000}

### Multiple Tweets {129830885752315000}

| | |
|--|--|
|__Name__| Multiple Tweets|
|__URL__| https://api.twitter.com/2/tweets?ids= |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/tweets?ids='
```
...
##### Example 1: 429 Rate Limit Exceeded - Multiple Tweets
...
##### Example 2: 200 Success - 1 Deleted, 1 Valid Tweet
...
##### Example 3: 200 Success - Multiple Tweets Default Payload
...
##### Example 4: 400 Bad Request - Too Many Tweets
...
##### Example 5: 200 Success - Multiple Tweets with Tweet Fields
...
### Single Tweet {394233794452341000}

| | |
|--|--|
|__Name__| Single Tweet|
|__URL__| https://api.twitter.com/2/tweets/:id |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/tweets/:id'
```
...
##### Example 1: 200 Success - Request Tweet fields
...
##### Example 2: 200 Success - Deleted Tweet
...
##### Example 3: 200 Success - Request Media Fields
...
##### Example 4: 429 Rate Limit Exceeded
...
##### Example 5: 200 Success - Default Payload (No additonal fields requested)
...
##### Example 6: 200 Success - Request Place Fields
...
##### Example 7: 200 Success - Request Poll Fields
...
## User Lookup {106703920852346000}

### User by ID {273191116052346000}

| | |
|--|--|
|__Name__| User by ID|
|__URL__| https://api.twitter.com/2/users/:id |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/users/:id'
```
...
##### Example 1: 200 Success - Request Fields for User and Expanded Pinned Tweet
...
##### Example 2: 200 Success - Default Payload
...
##### Example 3: 200 Success - User Not Found
...
##### Example 5: 429 Rate Limit Exceeded
...
### User by Username {210449708952480000}

| | |
|--|--|
|__Name__| User by Username|
|__URL__| https://api.twitter.com/2/users/by/username/:username |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/users/by/username/:username'
```
...
### Users by ID {198102533352487000}

| | |
|--|--|
|__Name__| Users by ID|
|__URL__| https://api.twitter.com/2/users?ids= |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/users?ids='
```
...
##### Example 1: 200 Success - Request User and Expanded Pinned Tweet Fields
...
##### Example 2: 200 Success - Multiple Users, 1 Not Found
...
##### Example 3: 200 Success - Request User Fields
...
##### Example 4: 200 Success - Default Payload
...
##### Example 5: 400 Bad Request - Too Many Users
...
### Users by Username {347888888052777000}

| | |
|--|--|
|__Name__| Users by Username|
|__URL__| https://api.twitter.com/2/users/by?usernames= |
|__Method__| GET|
...
```sh
curl -X 'GET' -d '' 'https://api.twitter.com/2/users/by?usernames='
```
...
##### Example 1: 200 Success - Default Payload
...
##### Example 2: 200 Success - Some Users Not Found
...
##### Example 4: 200 Success - Request Fields for Users and Expanded Pinned Tweet
...
##### Example 6: 429 Rate Limit Exceeded
